...
namespace Flagr.Api.Model
{
    ...
    public partial class CreateTagRequest :  IEquatable<CreateTagRequest>
    {
        ...
        public CreateTagRequest(string value = default(string))
        {
            // to ensure "value" is required (not null)
            if (value == null)
            {
                throw new InvalidDataException("value is a required property for CreateTagRequest and cannot be null");
            }
            else
            {
                this.Value = value;
