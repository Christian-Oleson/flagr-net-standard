...
namespace Flagr.Api.Api
{
    ...
    /// </summary>
    public partial interface IHealthApi : IApiAccessor
    {
        ...
        ApiResponse<Health> GetHealth_GETWithHttpInfo ();
        ...
        System.Threading.Tasks.Task<Health> GetHealth_GETAsync ();
        ...
        System.Threading.Tasks.Task<ApiResponse<Health>> GetHealth_GETAsyncWithHttpInfo ();
    ...
    public partial class HealthApi : IHealthApi
    {
        ...
        /// <returns></returns>
        public HealthApi(Flagr.Api.Client.Configuration configuration = null)
        {
        ...
        /// <exception cref="Flagr.Api.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>Health</returns>
        public Health GetHealth_GET ()
        {
            ApiResponse<Health> response = GetHealth_GETWithHttpInfo();
            if(response.StatusCode >= 400)
                throw new ApiException (response.StatusCode, "Error calling GetHealth_GET: " + response.Data, response.Data);
            if (response.StatusCode == 0)
                throw new ApiException (response.StatusCode, "Error calling GetHealth_GET: " + response.Headers, response.Headers);
        ...
        /// <exception cref="Flagr.Api.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>ApiResponse of Health</returns>
        public ApiResponse< Health > GetHealth_GETWithHttpInfo ()
        {

            const string localVarPath = "./health";
            ...
            Health resultingObject;
            string swaggerResponseMessage = null;

            try
            {
                resultingObject = (Health)this.Configuration.ApiClient.Deserialize(localVarResponse, typeof(Health));
            }
            catch
            {
            ...
            var apiResponse = new ApiResponse<Health>(localVarStatusCode,
        ...
        /// <exception cref="Flagr.Api.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>Task of Health</returns>
        public async System.Threading.Tasks.Task<Health> GetHealth_GETAsync ()
        {
            ApiResponse<Health> response = await GetHealth_GETAsyncWithHttpInfo();
            if(response.StatusCode >= 400)
                throw new ApiException(response.StatusCode, "Error calling GetHealth_GET: " + response.Data, response.Data);
            if (response.StatusCode == 0)
                throw new ApiException(response.StatusCode, "Error calling GetHealth_GET: " + response.Headers, response.Headers);
        ...
        /// <exception cref="Flagr.Api.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>Task of ApiResponse (Health)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<Health>> GetHealth_GETAsyncWithHttpInfo ()
        {
