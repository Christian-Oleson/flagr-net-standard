...
namespace Flagr.Api.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        {
            UserAgent = "StrategicApps-ViaSwaggerCodegen-csharp";
        ...
        public Configuration(
            ...
            int timeout = 100000,
            string userAgent = "StrategicApps-ViaSwaggerCodegen-csharp"
        ...
        public virtual ApiClient ApiClient
        {
            get
            {
                return _apiClient = _apiClient ?? CreateApiClient();
            }
        }
        ...
        {
            get => ApiClient.RestClient.Timeout = (int)TimeSpan.FromSeconds(300000).TotalMilliseconds;
            set { ApiClient.RestClient.Timeout = (int)TimeSpan.FromMilliseconds(value).TotalMilliseconds; }
        }
        ...
        public static String ToDebugReport()
        {
            ...
            report.Append("C# SDK (Flagr.Api) Debug Report:\n");
            report.Append("    OS: {System.Runtime.InteropServices.RuntimeInformation.OSDescription}\n");
            report.Append("    Version of the API: 1.1.12\n");
            report.Append("    SDK Package Version: 1.0.0\n");
