...
namespace Flagr.Api.Client
{
    ...
    public partial class ApiClient
    {
        ...
        public ApiClient()
        {
            Configuration = Flagr.Api.Client.Configuration.Default;
        ...
        {
            Configuration = config ?? Flagr.Api.Client.Configuration.Default;
            ...
            string contentType)
        {
            ...
            // set timeout
            RestClient.Timeout = TimeSpan.FromMilliseconds(Configuration.Timeout).Milliseconds;
